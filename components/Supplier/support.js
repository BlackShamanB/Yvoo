function Support() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full 3xl:gap-[168px] 2xl:gap-[110px] gap-[14px] px-[41px] customxs:px-[50px] 2xl:px-[162px] 3xl:px-[202px] pt-[48px] md:pt-[64px] 2xl:pt-[66px] 2xl:pb-[115px] pb-[100px] bg-white relative top-[-1px]">
