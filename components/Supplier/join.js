...
function Join() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full 3xl:gap-[171px] 2xl:gap-[110px] gap-[63px] px-[41px] customxs:px-[50px] 2xl:px-[162px] 3xl:px-[201px] md:pt-[180px] pt-[96px] md:pb-[122px] pb-[101px] md:bg-supplier2Bg3xl bg-supplier2Bg3 bg-no-repeat 2xl:bg-left bg-right-top mix-blend-screen">
      ...
      <div className="flex flex-col 2xl:gap-[47px] gap-[24px]">
        ...
        <button
          type="submit"
          className="rounded-[30px] filled_btn_primary btn_animated_blue hover:!text-black !text-[#06D7F9] md:!p-[18px_62px] !p-[8px_30px] !w-[max-content] md:!text-[16px] !text-[12px] md:!leading-[20px] !leading-[16px]"
          onClick={() => {
