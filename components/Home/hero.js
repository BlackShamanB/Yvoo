    ...
    <div className="relative w-full px-[20px] customsm:px-[50px] bg-[#414141] flex justify-center 3xl:pt-[162px] 2xl:pt-[162px] md:pt-[162px] pt-[80px] xl:pb-0 md:max-h-[1008px]">
      ...
      <LoadOnLoad>
        <div className="3xl:max-w-[1516px] 2xl:max-w-[1116px] md:max-w-[598px] 3xl:w-[1516px] 2xl:w-[1116px] mx-[auto] md:pl-[0] pl-[20px] md:pr-[0] pr-[20px] pb-[126px]">
          ...
          <div className="md:text-[24px] text-[18px] md:leading-[30px] leading-[26px] font-[700] md:mb-[42px] mb-[20px]">
            Achieve audit excellence: scale resources, cut costs by 70%,<br/> and
            accelerate timelines by 80%
          </div>
          <div className="text-black text-[16px] leading-[20px] font-[500] w-[max-content] p-[20px_64px] bg-blue rounded-[30px] md:mb-[60px] mb-[32px] uppercase"
        onClick={handleModal}>
            Book a demo
          </div>
