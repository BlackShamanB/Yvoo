function Hero() {
  ...
  return (
    <div className="relative w-full md:px-[20px] px-[41px] customsm:px-[50px] 3xl:bg-bg_supplier_discovery_with_matchory md:bg-solutionBgmd bg-solutionBg bg-no-repeat md:bg-contain bg-[size:100%] md:bg-[position:0_0] bg-[position:0_0%] flex justify-center 3xl:pt-[120px] md:pt-[162px] pt-[81px] xl:pb-0 md:max-h-[1008px] min-h-[820px]">
      <div className="3xl:max-w-[1516px] 2xl:max-w-[1116px] md:max-w-[598px] mx-[auto] relative w-full">
        ...
        >
          <div className="text-primary 2xl:mb-[12px] md:mb-[61px] mb-[62px] 2xl:text-[24px] md:text-[50px] text-[18px] 2xl:leading-[30px] md:leading-[54px] leading-[26px]">
            360° Supplier Score
          </div>
          <div className="font-[700] 2xl:text-[60px] text-[30px] 2xl:leading-[68px] leading-[34px]">
            Gain a 360° view of your suppliers’ readiness
          </div>
        </h1>
        <div
          className="font-[400] md:text-[24px] text-[18px] leading-[30px] leading-[26px] 2xl:max-w-[748px] mb-[42px] flex flex-col 3xl:gap-[20px] 2xl:gap-[20px] md:gap-[20px] flex-1 basis-[500px]"
          data-scroll
        ...
        <div
          className="text-black 2xl:text-[16px] text-[16px] 2xl:leading-[20px] leading-[16px] font-[500] w-[max-content] 2xl:p-[20px_64px] p-[16px_34px] bg-blue rounded-[30px] uppercase"
          onClick={handleModal}
        >
          Book a demo
        </div>
