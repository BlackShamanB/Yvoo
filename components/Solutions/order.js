function Order({ handleModal }) {
  return (
    <div className="w-full flex-between flex-wrap 2xl:flex-nowrap 3xl:gap-[33px] 2xl:gap-[67px] px-[20px] md:px-[50px] 2xl:px-[162px] 3xl:px-[202px] py-[64px] md:py-[105px] bg-[#53D3AA]">
