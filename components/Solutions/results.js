    ...
    <div className="relative grid w-full inset-0 bg-[#131D2A] -mt-[1px]">
      <div className="3xl:max-w-[1516px] 2xl:max-w-[1116px] md:max-w-[598px] mx-[auto] is-inview grid grid-cols-1 md:grid-cols-2 w-full">
          ...
          <div className="3xl:pl-[84px] 2xl:pl-[54px] w-full bg-[#131D2A]">
            <div className="my-[70px] md:my-[79px] flex flex-col gap-4">
              <h1 className="text-[#06D7F9] font-machina font-[800] uppercase text-[50px] 2xl:text-[50px] leading-[30px] 2xl:leading-[40px] max-w-full sm:max-w-[600px] md:max-w-[308px] 2xl:max-w-[650px]">
                Results that speak for themselves
              </h1>
              <h1 className="font-[700] text-[24px] leading-[24px] text-white">
                Don't settle for outdated practices. Embrace the future of
                sourcing with YVOO SourcerPro+
              </h1>
              <p className="text-white font-[400] text-[16px] leading-[16px]">
                Book a demo now and unlock the full potential of your
                procurement process.
              </p>
              <button
                className="white_btn mt-[16px]"
                onClick={handleModal}
              >
                Request Demo
              </button>
