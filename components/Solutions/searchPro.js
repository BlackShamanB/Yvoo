...
function SearchPro() {
  return (
    <div
      id="searchpro"
      className="w-full flex justify-between flex-wrap md:gap-[32px] px-[20px] customxs:px-[50px] lg:px-[176px] 2xl:px-[202px] py-[64px] md:py-[82px] 2xl:py-[18px] bg-mint"
    >
      <div className="relative w-full max-w-[726px] h-[728px] mt-[34px] md:mt-none">
        <Image
      ...
      <div className="[&>*]:text-black w-full md:max-w-[530px] 2xl:max-w-[735px] 3xl:pl-[63px] 3xl:pt-[79px]">
        ...
        <h2 className="mb-6 max-w-[317px] font-[700] text-[24px] leading-[30px]">
          Discover Quality Suppliers Effortlessly with
        </h2>
        <p className="font-[400] text-[14px] md:text-[16px] leading-[17px] md:leading-[20px] mb-[20px]">
        ...
        <p className="font-[400] text-[14px] md:text-[16px] leading-[17px] md:leading-[20px] mb-[42px]">
        ...
        <h2 className="mb-[25px] font-[500] text-[24px] leading-[30px]">
