  ...
  return (
    ...
    >
      <div className="relative w-full 3xl:max-w-[726px] 2xl:max-w-[746px] 3xl:h-[728px] 3xl:mt-[34px] md:mt-none" data-scroll data-scroll-speed="0.1">
        ...
        />
        <div className="absolute w-275px text-[16px] leading-[20px] font-[500] py-[20px] pl-[30px] pr-[26px] bg-[#000] 3xl:top-[230px] 2xl:top-[279px] 3xl:right-[-20px] 2xl:right-[63px] uppercase rounded-t-[30px] rounded-r-[30px] 2xl:block hidden">
          watch instructions
          <Image
      ...
      <div className="[&>*]:text-black w-full 3xl:max-w-[735px] 2xl:max-w-[598px] md:max-w-[unset] 3xl:pt-[79px] 2xl:pt-[94px] 3xl:pl-[63px] 3xl:pr-[0] 2xl:pr-[114px]" data-scroll data-scroll-speed="0.125">
