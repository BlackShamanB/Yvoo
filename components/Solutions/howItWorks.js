...
function HowItWorks() {
  return (
    <div className="relative w-full px-[41px] md:px-[85px] 2xl:px-[162px] 3xl:px-[202px] 2xl:pt-[150px] md:pt-[120px] pt-[100px] 3xl:pb-[150px] 2xl:pb-[126px] bg-white">
      ...
      />
      <h2 className="mb-[30px] 2xl:mb-[30px] 2xl:mb-[42px] text-black font-[700] 2xl:text-[32px] md:text-[28px] text-[26px] 2xl:leading-[36px] md:leading-[32px] leading-[30px]">
        Benefits that Await You:{" "}
      </h2>
      <div className="grid grid-cols-1 2xl:grid-rows-2 2xl:grid-cols-2 3xl:gap-x-[170px] 2xl:gap-x-[110px] 2xl:gap-y-[48px] md:gap-y-[30px] mb-[98px] md:mb-[125px] 2xl:mb-[114px] 3xl:mb-[194px]">
      ...
      <h1 className="text-black mb-[14px] md:mb-[21px] 2xl:mb-[30px] max-w-[300px] font-machina font-[800] uppercase text-[30px] md:text-[40px] 2xl:text-[50px] leading-[34px] md:leading-[44px] 2xl:leading-[54px]">
        How <br /> it works
      </h1>
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-[29px] md:gap-[24px] 2xl:gap-[40px] 3xl:gap-[158px] mb-[26px] md:mb-[23px] 2xl:mb-[70px]">
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-[26px] md:gap-[24px] 2xl:gap-[40px] 3xl::gap-[155px] mb-[101px] md:mb-[105px] 2xl:mb-[30px]">
