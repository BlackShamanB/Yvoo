...
function HowItWorks() {
  return (
    <div className="relative w-full px-[20px] md:px-[85px] 2xl:px-[162px] 3xl:px-[202px] 2xl:pt-[150px] md:pt-[120px] 3xl:pb-[150px] 2xl:pb-[126px] bg-white">
      <Image
      ...
      />
      <h2 className="mb-[30px] 2xl:mb-[30px] 2xl:mb-[42px] text-black font-[700] 2xl:text-[32px] text-[28px] 2xl:leading-[36px] leading-[32px]">
        Benefits that Await You:{" "}
      </h2>
      <div className="grid grid-cols-1 2xl:grid-rows-2 2xl:grid-cols-2 3xl:gap-x-[170px] 2xl:gap-x-[110px] 2xl:gap-y-[48px] md:gap-y-[30px] mb-[62px] md:mb-[125px] 2xl:mb-[114px] 3xl:mb-[194px]">
      ...
      <h1 className="text-black mb-[30px] md:mb-[21px] 2xl:mb-[30px] max-w-[300px] font-machina font-[800] uppercase text-[30px] md:text-[40px] 2xl:text-[50px] leading-[30px] md:leading-[44px] 2xl:leading-[54px]">
        How <br /> it works
      </h1>
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-[24px] 2xl:gap-[40px] 3xl:gap-[158px] mb-[66px] md:mb-[23px] 2xl:mb-[70px]">
        ...
        <div className="border border-[#53D3AA] border-solid mt-[-8px] mb-[10px] 2xl:hidden block"></div>
        <div className="[&>*]:text-black flex flex-col 3xl:gap-[14px] gap-[19px] md2:max-w-[306px] 2xl:max-w-[400px] 3xl:mt-[-60px] 2xl:mt-[-62px]">
          <h1 className="!text-[#53D3AA] font-machina font-[800] uppercase text-[36px] md:text-[40px] leading-[30px] md:leading-[36px] md:leading-[40px]">
            STEP 1
          </h1>
          <p className="font-[400] text-[14px] md:text-[16px] leading-[17px] md:leading-[20px] 2xl:mb-6 mb-[12px]">
      ...
      <div className="border border-[#53D3AA] border-solid 3xl:mb-[93px] mb-[90px] 2xl:block hidden"></div>
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-[24px] 2xl:gap-[40px] 3xl::gap-[155px] mb-[66px] md:mb-[105px] 2xl:mb-[30px]">
        <div className="[&>*]:text-black flex flex-col 3xl:gap-[14px] gap-[19px] md2:max-w-[306px] 2xl:max-w-[400px]">
          <h1 className="!text-[#53D3AA] font-machina font-[800] uppercase text-[36px] md:text-[40px] leading-[30px] leading-[36px] md:leading-[40px]">
            STEP 3
          </h1>
          <p className="font-[400] text-[14px] md:text-[16px] leading-[17px] md:leading-[20px] 2xl:mb-6 mb-[12px]">
        ...
        <div className="[&>*]:text-black flex flex-col 3xl:gap-[14px] gap-[19px] md2:max-w-[306px] 2xl:max-w-[400px]">
          <h1 className="!text-[#53D3AA] font-machina font-[800] uppercase text-[36px] md:text-[40px] leading-[36px] md:leading-[40px]">
            STEP 5
          </h1>
          <p className="font-[400] text-[14px] md:text-[16px] leading-[17px] md:leading-[20px] 2xl:mb-6 mb-[12px]">
