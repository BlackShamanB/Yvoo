function Hero() {
  return (
    ...
    <div className="relative w-full md:px-[20px] px-[42px] customsm:px-[50px] md:h-[820px] md:height-[unset] height-[874px] 3xl:bg-solutionBg3xl md:bg-solutionBgmd bg-solutionBg bg-no-repeat md:bg-contain bg-[size:100%] md:bg-[position:0_0] bg-[position:0_0%] flex justify-center 3xl:pt-[162px] md:pt-[156px] pt-[75px] xl:pb-0 md:max-h-[1008px]">
      <div
      ...
      >
        <h1 className="3xl:max-w-[726px] 2xl:max-w-[530px] font-machina font-[800] uppercase 2xl:text-[50px] md:text-[40px] text-[30px] 2xl:leading-[54px] md:leading-[44px] leading-[34px] flex-1 2xl:mb-[0] md:mb-[30px] mb-[63px]" data-scroll data-scroll-speed="0.15">
          ...
          <b className="text-primary">YVOO</b>
        </h1>
        <div className="3xl:pt-[184px] 2xl:pt-[191px] 3xl:pl-[85px] 2xl:pl-[55px] font-[400] text-[14px] md:text-[16px] leading-[20px] flex flex-col 3xl:gap-[20px] 2xl:gap-[20px] md:gap-[20px] flex-1 basis-[500px]" data-scroll data-scroll-speed="0.1">
          ...
          <p>
          Enter YVOO. Our cutting-edge digital platform transforms the way you find and audit suppliers, empowering you to maintain sourcing standards, uphold ESG commitments, navigate complex markets, and bolster operational resilience.
          </p>
        </div>
      </div>
    </div>
